...
//                  10-bit addressing (perhaps not - no hardware to test)
//                  General Call
//                  Software Reset
//                  START Byte
...
inline void t4sleep(unsigned long ticks)
{
...
// Returns true if address was acknowledged and false otherwise.
...
void I2CInit()
{
    ...
    gpio = CQEGpioInt::GetPtr();
    gpio->SetDataDirection(0x0007);
    gpio->SetData(0x0000);
