...
//char *default_argv[] = {"roombaVEXPro", "-p/dev/ttyAM1", "-E0"}; // alg 0 bumpturn forever
//int default_argc = 3;
//char *default_argv[] = {"roombaVEXPro", "-p/dev/ttyAM1", "-a0", "-E1"};	// alg 1 waypoint pattern N
//int default_argc = 4;
//char *default_argv[] = {"roombaVEXPro", "-p/dev/ttyAM1", "-a360", "-E2"}; // spin
//int default_argc = 4;
//char *default_argv[] = {"roombaVEXPro", "-p", "/dev/ttyAM1", "-E3"}; // alg 3 bumpturn forever in virtual cage
//int default_argc = 4;
//char *default_argv[] = {"roombaVEXPro", "-p/dev/ttyAM1", "-a2", "-E4"}; // alg 4 waypoint pattern n with grabber test
//int default_argc = 4;
//char *default_argv[] = {"roombaVEXPro", "-p/dev/ttyAM1", "-E5"}; // alg 5 point2VisualTarget
//int default_argc = 3;
//char *default_argv[] = {"roombaVEXPro", "-p/dev/ttyAM1", "-a780", "-E6"}; // alg 6 RoboColumbus
//int default_argc = 4;
char *default_argv[] = {"roombaVEXPro", "-p/dev/ttyAM1", "-a48", "-E7"}; // alg 7 tableBot
int default_argc = 4;
...
void usage()
{
    ...
    "  -E, --explore=alg            Move using an algorithm. 0: bounce off walls & cliffs. 1: drive a pattern of waypoints. \n"
    "                               2: spin. 3: Virtual cage. 4: RoboColumbus. 5: TableTop\n"
...
int main(int argc, char *argv[]) 
{
    ...
    int waypointList2[] = {1, 0, 20};	// 20" line
    ...
    /* parse options executing as we go*/
